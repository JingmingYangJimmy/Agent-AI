...
const App = () => {
  ...
  const handleResp = (question, answer) => {//if keep asking question, it may miss info
    //so we use progressive update ((prev) =>) turn it into a function to call 
     setConversation((prev) => [...prev, { question, answer }]);
  };

  return (//from top to bottom, layout in here
    <>
